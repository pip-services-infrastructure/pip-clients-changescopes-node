# Development and Testing Guide <br/> Change Scopes Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services/pip-clients-changescopes-node.git
```
