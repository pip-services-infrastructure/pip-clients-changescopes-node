...
class ChangeScopesSenecaClientV1 extends pip_services_net_node_1.CommandableSenecaClient {
    constructor(config) {
        super('change_scopes');
        if (config != null)
...
exports.ChangeScopesSenecaClientV1 = ChangeScopesSenecaClientV1;
//# sourceMappingURL=ChangeScopesSenecaClientV1.js.map